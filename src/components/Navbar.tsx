          ...
          <Link href="/" className="flex items-center gap-3.5 group">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-[#E8F7F1] text-[#087A5B] text-xs font-bold px-2.5 py-0.5 rounded-full border border-[#00A878]/20">
                  2026
                </span>
              </div>
              <p className="text-xs text-[#4B5563] font-semibold tracking-wide uppercase">
            ...
            {escolaAtual ? (
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#E8F7F1] hover:bg-[#d8f1e7] border border-[#00A878]/30 text-sm font-bold text-[#087A5B] transition-all"
                >
                  <School className="w-4 h-4 text-[#00A878]" />
                  <span className="hidden sm:inline">{escolaAtual.sigla || escolaAtual.nome}</span>
                  <span className="text-xs bg-[#00A878] text-white px-2.5 py-0.5 rounded-full font-bold">
                    Painel
                  </span>
                </Link>
                <button
                  ...
                  className="p-2.5 rounded-xl bg-white hover:bg-rose-50 hover:text-rose-600 border border-[#E2EAE5] text-[#4B5563] transition-colors"
                >
            ...
            {isAdmin ? (
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-sm font-bold hover:bg-amber-100 transition-all"
                >
              ...
              <Link
                ...
                className="p-2.5 rounded-xl bg-[#F7F9F8] hover:bg-[#E8F7F1] border border-[#E2EAE5] text-[#4B5563] hover:text-[#087A5B] transition-colors"
              >
