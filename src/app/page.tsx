...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F8] text-[#17221D] flex flex-col">
      ...
      <section className="relative bg-white border-b border-[#E2EAE5] pt-6 pb-12 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E8F7F1] border border-[#00A878]/25 text-[#087A5B] text-xs font-bold shadow-2xs">
              <Sparkles className="w-4 h-4 text-[#00A878]" />
              <span>SEMED • PREFEITURA DE GONÇALVES DIAS - MA</span>
            </div>

            <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-[#17221D] leading-tight">
              Sistema de Inscrições & Gestão Esportiva Escolar
            </h1>

            <p className="text-base sm:text-lg text-[#68756E] leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4">
              <Link
                href="/escola/login"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#00A878] hover:bg-[#087A5B] text-white font-bold text-base shadow-sm hover:shadow-md flex items-center justify-center gap-2.5 transition-all duration-200 active:scale-98"
              >
              ...
              <Link
                href="/modalidades"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white hover:bg-[#F7F9F8] text-[#17221D] font-bold text-base border border-[#E2EAE5] hover:border-[#CBD5E1] flex items-center justify-center gap-2 transition-all duration-200 shadow-2xs"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-12 text-left">
            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-5 shadow-xs">
              <div className="flex items-center gap-2 text-[#087A5B] mb-1">
                ...
                <span className="text-xs uppercase font-bold tracking-wider text-[#68756E]">Escolas</span>
              </div>
              <p className="text-3xl font-black text-[#17221D]">{escolas.length}</p>
              <p className="text-[11px] text-[#68756E] mt-0.5">Cadastradas no JEGD</p>
            </div>

            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-5 shadow-xs">
              <div className="flex items-center gap-2 text-[#087A5B] mb-1">
                <Users className="w-4 h-4 text-[#00A878]" />
                <span className="text-xs uppercase font-bold tracking-wider text-[#68756E]">Atletas</span>
              </div>
              <p className="text-3xl font-black text-[#17221D]">{totalAtletas}</p>
              <p className="text-[11px] text-[#68756E] mt-0.5">Alunos inscritos</p>
            </div>

            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-5 shadow-xs">
              <div className="flex items-center gap-2 text-[#087A5B] mb-1">
                <Trophy className="w-4 h-4 text-[#00A878]" />
                <span className="text-xs uppercase font-bold tracking-wider text-[#68756E]">Modalidades</span>
              </div>
              <p className="text-3xl font-black text-[#17221D]">{modalidades.length}</p>
              <p className="text-[11px] text-[#68756E] mt-0.5">Categorias esportivas</p>
            </div>

            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-5 shadow-xs">
              <div className="flex items-center gap-2 text-[#087A5B] mb-1">
                <FileCheck className="w-4 h-4 text-[#00A878]" />
                <span className="text-xs uppercase font-bold tracking-wider text-[#68756E]">Inscrições</span>
              </div>
              <p className="text-3xl font-black text-[#17221D]">{totalInscricoes}</p>
              <p className="text-[11px] text-[#68756E] mt-0.5">Equipes submetidas</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-6 relative shadow-xs hover:shadow-md transition-shadow">
              <span className="text-4xl font-black text-[#E2EAE5] absolute top-4 right-4 select-none">01</span>
            ...
            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-6 relative shadow-xs hover:shadow-md transition-shadow">
              <span className="text-4xl font-black text-[#E2EAE5] absolute top-4 right-4 select-none">02</span>
              <div className="w-12 h-12 rounded-xl bg-[#E8F7F1] border border-[#00A878]/20 text-[#00A878] flex items-center justify-center mb-4">
            ...
            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-6 relative shadow-xs hover:shadow-md transition-shadow">
              <span className="text-4xl font-black text-[#E2EAE5] absolute top-4 right-4 select-none">03</span>
              <div className="w-12 h-12 rounded-xl bg-[#E8F7F1] border border-[#00A878]/20 text-[#00A878] flex items-center justify-center mb-4">
                <Trophy className="w-6 h-6" />
              </div>
              <h3 className="text-base font-bold text-[#17221D] mb-1.5">3. Montagem das Equipes</h3>
              <p className="text-xs text-[#68756E] leading-relaxed">
                Inscreva seus atletas nas modalidades coletivas e individuais respeitando os limites de vagas.
              </p>
            </div>

            <div className="bg-white border border-[#E2EAE5] rounded-2xl p-6 relative shadow-xs hover:shadow-md transition-shadow">
              <span className="text-4xl font-black text-[#E2EAE5] absolute top-4 right-4 select-none">04</span>
              <div className="w-12 h-12 rounded-xl bg-[#E8F7F1] border border-[#00A878]/20 text-[#00A878] flex items-center justify-center mb-4">
                <QrCode className="w-6 h-6" />
              </div>
              <h3 className="text-base font-bold text-[#17221D] mb-1.5">4. Fichas e Crachás</h3>
              <p className="text-xs text-[#68756E] leading-relaxed">
                Emita os relatórios de lote em PDF e imprima os crachás com QR Code para validação na mesa.
              </p>
            </div>
            ...
            {modalidades.slice(0, 6).map((mod) => (
              ...
              >
                <div className="flex items-center justify-between mb-3.5">
                  <span className="text-[11px] font-bold px-3 py-1 rounded-full bg-[#EDF7F2] text-[#087A5B] border border-[#00A878]/20 uppercase">
                    {mod.tipo}
                  </span>
                ...
                <p className="text-xs text-[#68756E] mb-4 line-clamp-2 leading-relaxed">
                  {mod.descricao}
                </p>

                <div className="pt-3.5 border-t border-[#E2EAE5] flex items-center justify-between text-xs text-[#68756E]">
                  <div className="flex items-center gap-1">
                    <span className="px-2 py-0.5 rounded bg-[#F7F9F8] text-[#17221D] font-medium border border-[#E2EAE5]">
                      {mod.categoriasPermitidas?.[0] || 'Infantil'}
                    </span>
                  </div>
                  <span className="text-[#087A5B] font-semibold">
      ...
      {/* CTA PARA AS ESCOLAS */}
      <section className="py-16 bg-[#E8F7F1] border-t border-[#00A878]/20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#68756E] text-sm sm:text-base max-w-2xl mx-auto mb-8 leading-relaxed">
